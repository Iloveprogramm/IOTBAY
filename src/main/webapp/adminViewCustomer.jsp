...
<%
    List<AccountController> accounts = database.adminGetCustomerAccounts();
...
<body>
  <header>
        <h1>admin View Customer Page</h1>
    <nav>
  ...
  <h1>Account List</h1>
  <form method="GET" action="adminViewCustomer.jsp">
    ...
    <tr>
      ...
      <td>
        <form method="POST" action="adminEditAcc.jsp">
          ...
          <input type="hidden" name="newAccType" value = "Customer">
