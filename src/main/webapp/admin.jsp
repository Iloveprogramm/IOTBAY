...
<%
    ...
    (account.getPhonenum() != null && account.getPhonenum().toLowerCase().contains(filter.toLowerCase()))) {
...
<body>
  <header>
        <h1>Account Page</h1>
    <nav>
        <button onclick="location.href='staff.jsp'">Home</button>
        <button onclick="location.href='adminViewCustomer.jsp'">Customer</button>
        <button onclick="location.href='adminViewStaff.jsp'">Staff</button>
...
<!--          <h3><%=database.viewAllAccounts()%></h3>-->
